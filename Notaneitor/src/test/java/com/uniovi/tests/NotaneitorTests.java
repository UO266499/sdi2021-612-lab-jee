...
//	// Funciona a mano, pero no en el test, timeout
//	@Test
//	public void PR05() {
...
//	@Test
//	public void PR12() {
//		PO_PrivateView.defaultLogin(driver, "99999990A", "123456", "Notas del usuario");
//		
...
//		PO_PrivateView.defaultLogin(driver, "99999993D", "123456", "99999993D");
//		
//		PO_PrivateView.checkMenuMarks(driver,"delete",0,"","");
//	
//	}
//	
	@Test
	public void Prueba1() {
		PO_PrivateView.defaultLogin(driver, "99999988F", "123456", "99999988F");
	}
	...
	public void Prueba2() {
		...
		List<WebElement> elemento = PO_View.checkElement(driver, "free", "//a[contains(@id,'professor/add')]/a");
		elemento.get(0).click();
		PO_PrivateView.fillFormAddProfessor(driver, "Alexander", "Lopez", "Computer Science", "99999977F");
		PO_View.checkKey(driver, "Error.professor.dni.duplicate", PO_Properties.getSPANISH());
		PO_PrivateView.clickOption(driver, "logout", "text", "Identifícate");
	}
